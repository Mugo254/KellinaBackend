...
def _is_in_group(user, group_name):
    #Takes a user and a group name and returns True if user is in that group
    try:
...
class IsLoggedInUserOrClient(permissions.BasePermission):
